...
public class SQLAgenda extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String query = "CREATE TABLE `CLIENTE` ( `ID` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE, `NOMBRE` TEXT NOT NULL, `APELLIDO` TEXT NOT NULL, `DNI` INTEGER NOT NULL UNIQUE, `CALLE` TEXT NOT NULL, `ALTURA` INTEGER NOT NULL, `PISO` INTEGER, `TELEFONO` INTEGER NOT NULL )";
